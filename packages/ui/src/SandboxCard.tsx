    ...
    <div className="arf-card-light flex flex-col p-7">
      ...
      <div className="mt-auto flex flex-wrap gap-2.5">
        <button
          ...
          onClick={onTryLive}
          disabled={loading}
          className="inline-flex items-center gap-2 rounded-[9px] bg-arf-blue bg-gradient-to-br from-arf-blue to-arf-purple px-4 py-2.5 text-sm font-semibold text-white transition hover:brightness-110 active:scale-[0.96] disabled:opacity-50 disabled:active:scale-100"
        >
          {loading ? (
            <>
